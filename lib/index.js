 ...
 * @param {Number} [options.limit=5] limit the number of results/features returned from the query.
 ...
 * properties. This is only enacted when querying more than a single tile at a time.
 *
 * @example
